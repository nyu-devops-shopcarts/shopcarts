...
######################################################################
    ...
    #     shopcart = ShopCart(id = 1, customer_id = 1)
    #     serial_shopcart = shopcart.serialize()
    #     new_shopcart = ShopCart(id = 1, customer_id = 1)
    ...
    #     # create a dictionary that deserializes a cart
    ...
    # Deserialize cart with items too 
